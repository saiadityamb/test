    ...
    document.getElementById("Main_Image").style.width="100%"
...
function 
Call_Clicks_Plumber(){
    let CallClicks_New = firebase.database().ref("Call_Clicks_Plumber");
...
let CallClicks = firebase.database().ref("Call_Clicks_Plumber").child("amount");
...
//    document.getElementById("Mobile_Number_12").innerHTML="Call us "+num
   ...
   document.getElementById("Mobile_Number_Plumber").href="tel:"+num;
   document.getElementById("Mobile_Test").href="tel:"+num;
   document.getElementById("Mobile_Test").innerHTML=num;

...
function Call_Clicks(){
    let CallClicks_New = firebase.database().ref("Apartments_Enquiry_3").child("Call_Clicks");
...
let SticyCallButton = firebase.database().ref("Apartments_Enquiry_3").child("Sticky-Call-Button");
...
let CallClicks = firebase.database().ref("Apartments_Enquiry_3").child("Call_Clicks").child("amount");
...
let MobileNumber = firebase.database().ref("Apartments_Enquiry_3/Content_Section").child("Tagline");
